...
import { Dialog, DialogTitle, DialogContent, TextField, DialogActions, Button, Typography, Container,DialogContentText } from '@mui/material';
...
import { Box, List, ListItem, ListItemIcon, ListItemText, AppBar, Toolbar, CssBaseline, Link, Divider, IconButton, Avatar, Menu, MenuItem,Paper } from '@mui/material';
...
const Profile = () => {
 ...
 useEffect(() => {
    const getUsers = async () => {
      ...
      const matchedProfile = userList.find(profile => profile.user_id === user.uid);
      if (matchedProfile) {
